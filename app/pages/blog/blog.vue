  ...
  <div class="max-w-3xl mx-auto py-10">
    ...
    <div class="space-y-8">
      <NuxtLink
          ...
          :key="post.path"
          :to="post.path"
          class="group block p-6 rounded-2xl border border-gray-50 bg-white hover:border-orange-100 hover:shadow-xl hover:shadow-orange-500/5 transition-all"
      >
        <div class="flex justify-between items-start mb-2">
          <time class="text-xs font-mono text-orange-500 font-bold bg-orange-50 px-2 py-0.5 rounded">
            {{ post.date }}
          </time>
        ...
        <h3 class="text-xl font-bold text-gray-700 group-hover:text-orange-600 transition-colors">
          {{ post.title }}
        </h3>
        ...
        <div class="mt-4 flex items-center text-xs font-bold text-orange-400 opacity-0 group-hover:opacity-100 transition-opacity">
