    ...
    <div class="grid grid-cols-1 gap-6">
      <div v-for="org in orgs" :key="org.path"
        ...
        <div class="w-full md:w-48 h-48 bg-gray-50 flex items-center justify-center overflow-hidden relative">
          <Icon :name="org.logo || 'lucide:users'"
            ...
            <div class="flex justify-between items-start">
              <div>
                ...
                <div class="flex items-center gap-3 mt-1">
                  <span class="text-[10px] font-mono px-1.5 py-0.5 bg-gray-100 text-gray-500">EST. {{ org.founded }}</span>
                  <span class="text-[10px] font-mono px-1.5 py-0.5 bg-blue-50 text-blue-600">MEMBERS: {{ org.members_count }}</span>
                </div>
              </div>
